...
public class SoulForgeRecipesSorter implements Comparator {
    final RecipesSoulForge smithsCraftingManager;

    SoulForgeRecipesSorter(RecipesSoulForge par1RecipesSoulForge)
    {
             this.smithsCraftingManager = par1RecipesSoulForge;
    }
