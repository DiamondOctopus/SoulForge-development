...
public class BlockSoulForge extends Block
{
    ...
    public BlockSoulForge(int par1)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("soulforge:soulForge_side2"); //front
        this.field_94385_a = par1IconRegister.registerIcon("soulforge:soulForge_top"); //top
        this.field_94384_b = par1IconRegister.registerIcon("soulforge:soulForge_side"); //side
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        if (!player.isSneaking()){
            player.openGui(mod_soulforge.instance, 1, world, x, y, z);
            return true;
            }
        else{
            return false;
